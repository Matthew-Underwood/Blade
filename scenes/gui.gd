...
func _ready():
	var worldCoordinates = get_node("Panel/Container/WorldCoordinates")
	var localCoordinates = get_node("Panel/Container/LocalCoordinates")
	var layers = get_node("Panel/Container/HBoxContainer/LayerData/Layers")
	var tileLayers = get_node("Panel/Container/HBoxContainer/TileData/Layers")
